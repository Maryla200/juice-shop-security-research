...
این ریپو بیشتر جنبه‌ی دفترچه‌ی یادگیری داره تا گزارش رسمی — بیشتر برای مستندسازی روند کار هست.

> ⚠️ **Disclaimer**
> تمام تست‌ها و تحلیل‌های این مستندات روی محیط آزمایشگاهی محلی (Kali Linux, VMware) و اپلیکیشن عمداً آسیب‌پذیر [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) انجام شده‌اند. هیچ سیستم واقعی یا متعلق به شخص ثالث تست نشده است. 
این محتوا صرفاً برای یادگیری و مستندسازی شخصی تهیه شده.
